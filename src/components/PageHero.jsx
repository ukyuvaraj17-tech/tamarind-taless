...
export default function PageHero({ image, position, eyebrow, title, subtitle, minHeight = 280 }) {
  return (
    <div style={{
      position: 'relative',
      minHeight,
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, padding: '52px 44px 48px' }}>
        ...
        {eyebrow && <p className="eyebrow" style={{ marginBottom: 12, color: image ? '#F2EFE4' : 'var(--gold-muted)' }}>{eyebrow}</p>}
        <h1 style={{
