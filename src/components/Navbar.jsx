  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', top: 64, left: 0, right: 0, background: 'var(--nav)', zIndex: 999, borderBottom: '1px solid var(--line)', transform: menuOpen ? 'translateY(0)' : 'translateY(-110%)', opacity: menuOpen ? 1 : 0, transition: 'transform .35s cubic-bezier(.25,.46,.45,.94), opacity .3s', maxHeight: '80vh', overflowY: 'auto' }}>
        {[['Shop All','/shop'],['Bronze','/shop?cat=bronze'],['Wooden Art','/shop?cat=wooden'],['Paintings','/shop?cat=paintings'],['Brass','/shop?cat=brass'],['Miniatures','/shop?cat=miniatures'],['About','/about'],['Services','/services'],['Stories','/stories'],['Care Guide','/care'],['Blog','/blog'],['Contact','/contact'],[currentUser?'My Account':'Login',currentUser?'/account':'/login'],[`Cart (${cartCount})`,'/cart']].map(([l,p]) => (
