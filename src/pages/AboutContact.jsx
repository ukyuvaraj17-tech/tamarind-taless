...
export function About() {
  ...
  return (
    <>
      {/* HEADER */}
      <PageHero image={brand.hero_about} position={brand.hero_about_position} mobilePosition={brand.hero_about_mobile_position} eyebrow="The Brand" title="About Tamarind Taless" />
        ...
        <div className="container">
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:72, alignItems:'start' }} className="about-grid">
            ...
            <div>
              ...
              <p style={{ ...S.body, fontSize:20, fontStyle:'italic', color:'var(--iv)' }} ref={add(3)} className="reveal d2">We believe the most meaningful spaces and possessions are not simply acquired. They are collected, one story at a time.</p>
              <p style={{ ...S.body, fontSize:18, marginTop:18 }} ref={add(4)} className="reveal d3">Tamarind Taless began with two sisters and a shared love for India's heritage.</p>
              <p style={{ ...S.body, fontSize:18, marginTop:14 }} ref={add(5)} className="reveal d3">We are Sandhya and Vidya, and for as long as we can remember, we've been drawn to things that carry a story. A centuries old bronze, a handwoven saree, a forgotten heirloom, a painting weathered by time, or a craft that has quietly survived through generations. We never saw them as mere objects. To us, they carried memories, artistry, and a quiet sense of belonging.</p>
              <p style={{ ...S.body, fontSize:18, marginTop:14 }} ref={add(6)} className="reveal d4">What began as a personal passion slowly grew into Tamarind Taless.</p>
              <p style={{ ...S.body, fontSize:18, marginTop:14 }} ref={add(7)} className="reveal d4">Today, our journey takes us across India, where we meet artisans, collectors, and heritage families in search of pieces that deserve to be cherished for generations to come. Some are vintage treasures with lives of their own. Others are handcrafted by artisans who continue traditions passed down over centuries. Together, they celebrate the richness and diversity of India's artistic and cultural legacy.</p>
              <p style={{ ...S.body, fontSize:18, marginTop:14 }} ref={add(8)} className="reveal d4">At Tamarind Taless, we are not simply curating beautiful things. We are preserving stories, celebrating craftsmanship, and creating a space where India's heritage continues to find a place in contemporary lives and homes.</p>
              <p style={{ ...S.body, marginTop:22, fontStyle:'italic', color:'var(--gd)', fontSize:20 }} ref={add(9)} className="reveal d4">If these stories speak to you as deeply as they speak to us, we're so glad you're here.<br/>Welcome to Tamarind Taless.</p>
            </div>
          </div>
        </div>
      </section>
